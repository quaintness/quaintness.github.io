...
3. **`it`做形式主语/形式宾语** ==冒充native speaker的加分项==
...
3. `with/without`复合结构，不考虑逻辑主语
   ...
   :warning:在`with/without`复合结构中，`宾语`和后面的逻辑**主语**常常不同。 （该结构鼓励突出这种不同）
...
1. 什么时候加`the`？
   ...
   - 该名词后面有修饰
     ...
     e.g. <u>**The**</u> computer she bought was cheap.
...
3. `so/such ... that`结构中`So/Such`放在句首，发生半倒装
