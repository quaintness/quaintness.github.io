...
- Image classification problem has a lot of challenges like illumination and viewpoints.
  - ![39.jpeg](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/39.jpeg?raw=true)
...
- Loss function for a linear **SVM** classifier:
  ...
  - Example:
    - ![40.jpg](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/40.jpg?raw=true)
...
- **Optimization**:
  ...
  - Strategy two:
    - Follow the slope.
      ...
      - ![41.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/41.png?raw=true)
...
- Computing the analytic gradient for arbitrary complex functions:
  ...
  - A bigger example:
    ...
    - ![01.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/01.png?raw=true)
...
- Activation functions:
  ...
  - ![42.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/42.png?raw=true)
...
- This section talks about the famous CNN architectures. Focuses on CNN architectures that won [ImageNet](www.image-net.org/) competition since 2012.
  ...
  - ![43.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/43.png?raw=true)
...
- The first ConvNet that was made was [LeNet-5](http://ieeexplore.ieee.org/document/726791/) architectures are:by Yann Lecun at 1998.
  ...
  - Architecture are: `CONV-POOL-CONV-POOL-FC-FC-FC`
    - ![02.jpg](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/02.jpg?raw=true)
...
- [**VGGNet**](https://arxiv.org/pdf/1409.1556) (2014) (Oxford)
  ...
  - ![03.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/03.png?raw=true)
  ...
  - VGG19 are an upgrade for VGG16 that are slightly better but with more memory
    - ![04.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/04.png?raw=true)
...
- [**GoogleNet**](https://research.google.com/pubs/pub43022.html) (2014)
  ...
  - Inception module:
    ...
    - ![05.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/05.png?raw=true)
  ...
  - Full architecture:
    - ![44.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/44.png?raw=true)
...
- [**ResNet**](https://arxiv.org/abs/1512.03385) (2015) (Microsoft Research)
  ...
  - Residual block:
    ...
    - Microsoft came with the Residual block which has this architecture:
      ...
      - ![45.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/45.png?raw=true)
  ...
  - ResNet with a large number of layers started to use a bottleneck layer similar to the Inception bottleneck to reduce the dimensions.
    ...
    - ![07.jpg](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/07.jpg?raw=true)

  - **<u>Full ResNet architecture</u>**:

    - Stack residual blocks.
      - ![08.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/08.png?raw=true)
...
- The complexity comparing over all the architectures:
  ...
  - ![09.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/09.png?raw=true)
...
- Recurrent Neural Networks RNN Models:
  ...
  - ![46.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/46.png?raw=true)
  - One to many
...
- So what is a recurrent neural network?
  ...
  - ![47.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/47.png?raw=true)
...
- Recurrent NN Computational graph:
  ...
  - ![10.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/10.png?raw=true)
  - `h0` are initialized to zero.
  - Gradient of `W` is the sum of all the `W` gradients that has been calculated!
  - A many to many graph:
    - ![11.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/11.png?raw=true)
    - Also the last is the sum of all losses and the weights of Y is one and is updated through summing all the gradients!
  - A many to one graph:
    - ![12.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/12.png?raw=true)
  - A one to many graph:
    - ![13.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/13.png?raw=true)
  - sequence to sequence graph:
    - ![14.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/14.png?raw=true)
...
- Examples:
  ...
  - Suppose we are building words using characters. We want a model to predict the next character of a sequence. Lets say that the characters are only `[h, e, l, o]` and the words are [hello]
    - Training:
      - ![15.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/15.png?raw=true)
    ...
    - Testing time:
      - ![16.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/16.png?raw=true)
...
- Example on image captioning:
  ...
  - ![17.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/17.png?raw=true)
...
- LSTM stands for Long Short Term Memory. It was designed to help the vanishing gradient problem on RNNs.
  ...
  - ![18.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/18.png?raw=true)
  - ![18.1.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/18.1.png?raw=true)
...
- **<u>Semantic Segmentation</u>**
  ...
  - ![19.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/19.png?raw=true)
...
- **<u>Object Detection</u>**
  ...
  - There is another idea which is called R-CNN
    - ![20.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/20.png?raw=true)
  ...
  - Fast R-CNN is another idea that developed on R-CNN
    - ![48.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/48.png?raw=true)
...
- **<u>Instance Segmentation</u>**
  ...
  - ![49.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/49.png?raw=true)
...
- In AlexNet, there was some FC layers in the end. If we took the 4096-dimensional feature vector for an image, and collecting these feature vectors.
  ...
  - ![21.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/21.png?raw=true)
...
- We can Visualize the activation maps.
  ...
  - ![50.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/50.png?raw=true)
...
- Another idea is **Occlusion Experiments**
  ...
  - ![51.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/51.png?raw=true)
...
- **Gradient Ascent**
  ...
  - ![22.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/22.png?raw=true)
...
- Results on fooling the network is pretty surprising!
  ...
  - ![23.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/23.png?raw=true)
...
- Autoencoders are a Feature learning technique.
  ...
  - ![24.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/24.png?raw=true)
...
- **Generative Models**
  ...
  - Taxonomy of Generative Models:
    - ![52.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/52.png?raw=true)
...
- **Variational Autoencoders (VAE)**
  ...
  - But we cant compute integral for P(z)p(x|z)dz as the following equation:
    - ![25.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/25.png?raw=true)
  - After resolving all the equations that solves the last equation we should get this:
    - ![26.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/26.png?raw=true)
...
- **Generative Adversarial Networks (GANs)**
  ...
  - The loss function of GANs as minimax game are here:
    ...
    - ![27.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/27.png?raw=true)
  ...
  - You can read the full algorithm with the equations here:
    ...
    - ![28.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/28.png?raw=true)
...
- **Markov Decision Process**
  ...
  - For example:
    - ![29.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/29.png?raw=true)
  - Solution would be:
    - ![30.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/30.png?raw=true)
...
- We can get the optimal policy using the value iteration algorithm that uses the Bellman equation as an iterative update
  - ![31.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/31.png?raw=true)
...
- **Q-learning**
  ...
  - The loss function:
    - ![32.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/32.png?raw=true)
- Now lets consider the "Playing Atari Games" problem:
  ...
  - Q-network Architecture:
    - ![33.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/33.png?raw=true)
  ...
  - The full algorithm:
    - ![34.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/34.png?raw=true)
...
- **Policy Gradients**
  ...
  - Policy Gradients equations:
    - ![35.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/35.png?raw=true)
  ...
  - Equation and intuition of the Reinforce algorithm:
    - ![36.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/36.png?raw=true)
...
- Part 1: **<u>Algorithms for Efficient Inference</u>**
  ...
  - **Weight Sharing**
    ...
    - Using Pruning + Trained Quantization + Huffman Coding is called deep compression.
      - ![37.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/37.png?raw=true)
      - ![38.png](https://github.com/mbadry1/CS231n-2017-Summary/blob/master/Images/38.png?raw=true)
      - **SqueezeNet**
